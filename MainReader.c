 ...
 * -------------------------------------------------------------
 */
ez_void bErrorPrint(ez_string fmt, ...);
ez_void displayBuffer(Buffer* ptr_Buffer);
ez_long getFileSize(ez_string fname);
ez_int isNumber(const ez_string ns);
ez_void startReader(ez_string, ez_string, ez_char, ez_int, ez_int);
...
ez_int mainReader(ez_int argc, ez_string* argv) {
	...
	ez_string program = argv[0];
	ez_string input = argv[2];
	ez_char mode = MODE_FIXED;
	ez_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
ez_void startReader(ez_string program, ez_string input, ez_char mode, ez_int size, ez_int increment) {

	BufferPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	ez_int loadSize = 0;		/* the size of the file loaded in the buffer */
	ez_char symbol;			/* symbol read from input file */
